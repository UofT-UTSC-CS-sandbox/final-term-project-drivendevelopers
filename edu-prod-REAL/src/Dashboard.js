...
const Dashboard = () => {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', backgroundColor: '#f0f2f5' }}>
      {/* Side panel */}
      <div style={{ width: isCollapsed ? '60px' : '250px', backgroundColor: '#333', color: '#fff', padding: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center', transition: 'width 0.3s ease' }}>
        ...
        {!isCollapsed && (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
            <button onClick={handleProfileView} style={{ marginBottom: '1rem', padding: '10px 20px', borderRadius: '20px', border: 'none', backgroundColor: '#ff4d4f', color: '#fff', cursor: 'pointer', fontSize: '1rem' }}>View Profile</button>
            <button onClick={handleConnect} style={{ marginBottom: '1rem', padding: '10px 20px', borderRadius: '20px', border: 'none', backgroundColor: '#ff4d4f', color: '#fff', cursor: 'pointer', fontSize: '1rem' }}>Connect</button>
            <button onClick={handleProjects} style={{ marginBottom: '1rem', padding: '10px 20px', borderRadius: '20px', border: 'none', backgroundColor: '#ff4d4f', color: '#fff', cursor: 'pointer', fontSize: '1rem' }}>Projects</button>
            <button onClick={handleLogout} style={{ padding: '10px 20px', borderRadius: '20px', border: 'none', backgroundColor: '#ffd166', color: '#333', cursor: 'pointer', fontSize: '1rem' }}>Logout</button>
          </div>
        )}
      </div>
      {/* Main content */}
